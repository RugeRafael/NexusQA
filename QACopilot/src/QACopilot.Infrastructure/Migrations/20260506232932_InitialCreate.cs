    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuditMetrics", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AuditMetrics_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TestCaseHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TestCaseHistories_Documents_DocumentId",
                        column: x => x.DocumentId,
                        principalTable: "Documents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TestCaseHistories_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestCaseHistories_DocumentId",
                table: "TestCaseHistories",
                column: "DocumentId");

            migrationBuilder.CreateIndex(
                name: "IX_TestCaseHistories_UserId",
                table: "TestCaseHistories",
                column: "UserId");
